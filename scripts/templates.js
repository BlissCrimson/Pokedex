    ...
    return `
        ...
        <main id="mainDialog" class="main-dialog">
            ...
            <section name="buttons" class="area-btn">
                ...
                <button class="btn-pokemon-details bg_${pokemon.types[0].type.name}" onclick="toggleSecondDetails()">
                    <b>stats</b>
                </button>
                <button class="btn-pokemon-details bg_${pokemon.types[0].type.name}" onclick="toggleThirdDetails()">
                    <b>shiny</b>
                </button>
            </section>
            <section name="PokemonDetails" class="d_flex_column">
